...
export function Button({
  ...
  const base =
    ...
    'transform hover:scale-105 active:scale-95 min-h-12 sm:min-h-10';

  const sizing = size === 'lg' ? 'px-6 py-3.5 rounded-xl text-sm sm:text-base' : 'px-4 py-2.5 rounded-lg text-sm';
